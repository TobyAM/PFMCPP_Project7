...
void Character::boostInitialStats( int& current, int& initial)
{
...
void Character::attackInternal(Character& other)
{
    ...
    {
        boostInitialStats( hitPoints, *initialHitPoints);
        boostInitialStats( armor, *initialArmorLevel);
        boostInitialStats( attackDamage, *initialAttackDamage);
